...
**Source:** [Rizzoma BLB topic](https://rizzoma.com/topic/8eb682d3d68ba8bd27dea3d1eb50a6d3/0_b_bp6m_clkmv/)
...
## DOMAIN FOR THIS TAXONOMY

```
DOMAIN
<one or two sentences: what is this a taxonomy OF? Where does it stop?>

INSTANCE (the thing being classified)
<the single unit you will classify - an issue, an event, an argument, a policy.
NOT a document, not a paragraph, not a source.>

PRIMARY APPLICATION
<the corpus or period you will actually run it over.>
```

**Notes binding on the output:**

- Derive the High-Level Taxonomic Principles yourself from first principles and from the domain as
  defined. **No dimensions are supplied to you.**
- The instance is the thing named above, not the document it appears in. A taxonomy that mirrors your
  sources' own filing system fails this brief: it reproduces their structure instead of giving you an
  independent analytical view of it.
- Output the complete taxonomy in the **4-column TSV** specified above, with no deviation in format.
